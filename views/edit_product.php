    ...
    <main>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit_products.php?id=<?php echo $row['id']; ?>">ویرایش</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
        ...
        <div class="content">
            ...
            <form action="../controllers/EditProductController.php" method="post" enctype="multipart/form-data">
                ...
                <input type="text" id="name" name="name" value="<?php echo htmlspecialchars($editProduct->name, ENT_QUOTES, 'UTF-8'); ?>" required>

                <label for="description">توضیحات محصول:</label>
                <textarea id="description" name="description" required><?php echo htmlspecialchars($editProduct->description, ENT_QUOTES, 'UTF-8'); ?></textarea>

                <label for="price">قیمت:</label>
                <input type="number" id="price" name="price" value="<?php echo htmlspecialchars($editProduct->price, ENT_QUOTES, 'UTF-8'); ?>" required>

                <label for="image">تصویر:</label>
                <label id="file-label" class="custom-file-upload">
                    <input type="file" id="image" name="image" accept="image/*" onchange="showFileName(event)">
                    انتخاب فایل
                </label>
                <span id="file-name" class="file-name"><?php echo htmlspecialchars($editProduct->image, ENT_QUOTES, 'UTF-8'); ?></span>
