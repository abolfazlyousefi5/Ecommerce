...
<body id="ba">
    ...
    <main>
        <div class="hero">
            <h2>بهترین محصولات الکترونیکی</h2>
            <h4>جدیدترین و با کیفیت‌ترین محصولات الکترونیکی را از ما بخرید</h4>
            <a href="controllers/product_controller.php" class="btn">مشاهده محصولات</a>
        </div>
    </main>
    <footer>
